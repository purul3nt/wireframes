jQuery("#simulation")
  .on("click", ".s-45420977-ccb0-44c3-8609-8033d81b7649 .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Image_33")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/6b377006-b0e4-48f1-910c-36d569d2a7c0",
                    "transition": {
                      "type": "slidedown",
                      "duration": 700
                    }
  ...
  .on("pageload", ".s-45420977-ccb0-44c3-8609-8033d81b7649 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
